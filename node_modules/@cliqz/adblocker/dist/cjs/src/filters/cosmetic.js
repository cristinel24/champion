...
class CosmeticFilter {
    ...
    static parse(line, debug = false) {
        ...
        if (line.length > afterSharpIndex) {
            if (line[afterSharpIndex] === '@') {
                mask = (0, utils_1.setBit)(mask, 1 /* unhide */);
                suffixStartIndex += 1;
            }
        ...
        if (line.endsWith(':remove()')) {
            // ##selector:remove()
            mask = (0, utils_1.setBit)(mask, 64 /* remove */);
            mask = (0, utils_1.setBit)(mask, 128 /* extended */);
            line = line.slice(0, -9);
        }
        ...
        if (line.charCodeAt(suffixStartIndex) === 94 /* '^' */) {
            ...
            if ((domains === undefined ||
                ...
                (0, utils_1.getBit)(mask, 1 /* unhide */) === false) {
                return null;
            }
            mask = (0, utils_1.setBit)(mask, 2 /* scriptInject */);
            ...
            if ((0, utils_1.getBit)(mask, 1 /* unhide */) === false && selector.length === 0) {
                return null;
            }
        }
        else {
        ...
        if (domains === undefined && (0, utils_1.getBit)(mask, 128 /* extended */) === true) {
            return null;
        }
        if (selector !== undefined) {
            // Check if unicode appears in selector
            if ((0, utils_1.hasUnicode)(selector)) {
                mask = (0, utils_1.setBit)(mask, 4 /* isUnicode */);
            }
            // Classify selector
            if ((0, utils_1.getBit)(mask, 2 /* scriptInject */) === false &&
                (0, utils_1.getBit)(mask, 64 /* remove */) === false &&
                (0, utils_1.getBit)(mask, 128 /* extended */) === false &&
                ...
                if ((0, utils_1.getBit)(mask, 2 /* scriptInject */) === false) {
                    if (c0 === 46 /* '.' */ && isSimpleSelector(selector)) {
                        mask = (0, utils_1.setBit)(mask, 8 /* isClassSelector */);
                    }
                    else if (c0 === 35 /* '#' */ && isSimpleSelector(selector)) {
                        mask = (0, utils_1.setBit)(mask, 16 /* isIdSelector */);
                    }
                    else if (c0 === 97 /* a */ &&
                        c1 === 91 /* '[' */ &&
                        c2 === 104 /* 'h' */ &&
                        isSimpleHrefSelector(selector, 2)) {
                        mask = (0, utils_1.setBit)(mask, 32 /* isHrefSelector */);
                    }
                    else if (c0 === 91 /* '[' */ &&
                        c1 === 104 /* 'h' */ &&
    ...
    static deserialize(buffer) {
        ...
        const isUnicode = (0, utils_1.getBit)(mask, 4 /* isUnicode */);
    ...
    isExtended() {
        return (0, utils_1.getBit)(this.mask, 128 /* extended */);
    }
    isRemove() {
        return (0, utils_1.getBit)(this.mask, 64 /* remove */);
    }
    isUnhide() {
        return (0, utils_1.getBit)(this.mask, 1 /* unhide */);
    }
    isScriptInject() {
        return (0, utils_1.getBit)(this.mask, 2 /* scriptInject */);
    }
    isCSS() {
        return this.isScriptInject() === false;
    }
    isIdSelector() {
        return (0, utils_1.getBit)(this.mask, 16 /* isIdSelector */);
    }
    isClassSelector() {
        return (0, utils_1.getBit)(this.mask, 8 /* isClassSelector */);
    }
    isHrefSelector() {
        return (0, utils_1.getBit)(this.mask, 32 /* isHrefSelector */);
    }
    isUnicode() {
        return (0, utils_1.getBit)(this.mask, 4 /* isUnicode */);
    }
    isHtmlFiltering() {
