...
class NetworkFilter {
    ...
    static parse(line, debug = false) {
        ...
        if (line.charCodeAt(0) === 64 /* '@' */ && line.charCodeAt(1) === 64 /* '@' */) {
            filterIndexStart += 2;
            mask = (0, utils_1.setBit)(mask, 134217728 /* isException */);
        }
        ...
        if (optionsIndex !== -1 && line.charCodeAt(optionsIndex + 1) !== 47 /* '/' */) {
            ...
            for (const rawOption of line.slice(optionsIndex + 1).split(',')) {
                ...
                switch (option) {
                    ...
                    case 'badfilter':
                        mask = (0, utils_1.setBit)(mask, 131072 /* isBadFilter */);
                        break;
                    case 'important':
                        ...
                        mask = (0, utils_1.setBit)(mask, 1048576 /* isImportant */);
                        break;
                    case 'match-case':
                        // Note: `negation` should always be `false` here.
                        if (negation) {
                    ...
                    case 'third-party':
                        if (negation) {
                            ...
                            mask = (0, utils_1.clearBit)(mask, 32768 /* thirdParty */);
                        }
                        else {
                            // third-party means ~first-party
                            mask = (0, utils_1.clearBit)(mask, 16384 /* firstParty */);
                        }
                        break;
                    case '1p':
                    case 'first-party':
                    ...
                    case 'redirect':
                        ...
                        if (option === 'redirect-rule') {
                            mask = (0, utils_1.setBit)(mask, 536870912 /* isRedirectRule */);
                        }
                    ...
                    case 'csp':
                        ...
                        mask = (0, utils_1.setBit)(mask, 262144 /* isCSP */);
                        if (optionValue.length > 0) {
                            csp = optionValue;
                        }
                        break;
                    ...
                    case 'elemhide':
                        ...
                        mask = (0, utils_1.setBit)(mask, 524288 /* isGenericHide */);
                        mask = (0, utils_1.setBit)(mask, 2097152 /* isSpecificHide */);
                        break;
                    case 'shide':
                    case 'specifichide':
                        if (negation) {
        ...
        if (filterIndexEnd - filterIndexStart >= 2 &&
            ...
            mask = (0, utils_1.setBit)(mask, 4194304 /* isFullRegex */);
        }
        else {
            // Deal with hostname pattern
            if (filterIndexEnd > 0 && line.charCodeAt(filterIndexEnd - 1) === 124 /* '|' */) {
                mask = (0, utils_1.setBit)(mask, 67108864 /* isRightAnchor */);
                filterIndexEnd -= 1;
            }
            if (filterIndexStart < filterIndexEnd &&
                ...
                if (filterIndexStart < filterIndexEnd - 1 &&
                    ...
                    mask = (0, utils_1.setBit)(mask, 268435456 /* isHostnameAnchor */);
                    filterIndexStart += 2;
                }
                else {
                    mask = (0, utils_1.setBit)(mask, 33554432 /* isLeftAnchor */);
                    filterIndexStart += 1;
                }
            }
            ...
            if ((0, utils_1.getBit)(mask, 268435456 /* isHostnameAnchor */)) {
                ...
                if (firstSeparator === filterIndexEnd) {
                    ...
                    if (separatorCode === 94 /* '^' */) {
                        ...
                        if (filterIndexEnd - filterIndexStart === 1) {
                            ...
                            mask = (0, utils_1.setBit)(mask, 8388608 /* isRegex */);
                            mask = (0, utils_1.setBit)(mask, 33554432 /* isLeftAnchor */);
                        }
                    }
            ...
            if ((0, utils_1.getBit)(mask, 268435456 /* isHostnameAnchor */) === false &&
                filterIndexEnd - filterIndexStart > 0 &&
                line.charCodeAt(filterIndexStart) === 42 /* '*' */) {
                mask = (0, utils_1.clearBit)(mask, 33554432 /* isLeftAnchor */);
                filterIndexStart += 1;
            }
            // Transform filters on protocol (http, https, ws)
            if ((0, utils_1.getBit)(mask, 33554432 /* isLeftAnchor */)) {
                if (filterIndexEnd - filterIndexStart === 5 &&
                    (0, utils_1.fastStartsWithFrom)(line, 'ws://', filterIndexStart)) {
                    mask = (0, utils_1.setBit)(mask, 4096 /* fromWebsocket */);
                    mask = (0, utils_1.clearBit)(mask, 33554432 /* isLeftAnchor */);
                    mask = (0, utils_1.clearBit)(mask, 4 /* fromHttp */);
                    mask = (0, utils_1.clearBit)(mask, 8 /* fromHttps */);
                    filterIndexStart = filterIndexEnd;
                }
                else if (filterIndexEnd - filterIndexStart === 7 &&
                    (0, utils_1.fastStartsWithFrom)(line, 'http://', filterIndexStart)) {
                    mask = (0, utils_1.setBit)(mask, 4 /* fromHttp */);
                    mask = (0, utils_1.clearBit)(mask, 8 /* fromHttps */);
                    mask = (0, utils_1.clearBit)(mask, 33554432 /* isLeftAnchor */);
                    filterIndexStart = filterIndexEnd;
                }
                    ...
                    mask = (0, utils_1.setBit)(mask, 8 /* fromHttps */);
                    mask = (0, utils_1.clearBit)(mask, 4 /* fromHttp */);
                    mask = (0, utils_1.clearBit)(mask, 33554432 /* isLeftAnchor */);
                    filterIndexStart = filterIndexEnd;
                }
            ...
            if (filterIndexEnd - filterIndexStart > 0) {
                ...
                mask = setNetworkMask(mask, 16777216 /* isUnicode */, (0, utils_1.hasUnicode)(filter));
                if ((0, utils_1.getBit)(mask, 8388608 /* isRegex */) === false) {
    ...
    static deserialize(buffer) {
        ...
        const isUnicode = (0, utils_1.getBit)(mask, 16777216 /* isUnicode */);
    ...
    isRedirectRule() {
        return (0, utils_1.getBit)(this.mask, 536870912 /* isRedirectRule */);
    }
    getRedirect() {
    ...
    isException() {
        return (0, utils_1.getBit)(this.mask, 134217728 /* isException */);
    }
    isHostnameAnchor() {
        return (0, utils_1.getBit)(this.mask, 268435456 /* isHostnameAnchor */);
    }
    isRightAnchor() {
        return (0, utils_1.getBit)(this.mask, 67108864 /* isRightAnchor */);
    }
    isLeftAnchor() {
        return (0, utils_1.getBit)(this.mask, 33554432 /* isLeftAnchor */);
    }
    isImportant() {
        return (0, utils_1.getBit)(this.mask, 1048576 /* isImportant */);
    }
    isFullRegex() {
        return (0, utils_1.getBit)(this.mask, 4194304 /* isFullRegex */);
    }
    isRegex() {
        return ((0, utils_1.getBit)(this.mask, 8388608 /* isRegex */) ||
            (0, utils_1.getBit)(this.mask, 4194304 /* isFullRegex */));
    }
    isPlain() {
        return !this.isRegex();
    }
    isCSP() {
        return (0, utils_1.getBit)(this.mask, 262144 /* isCSP */);
    }
    isElemHide() {
        return this.isSpecificHide() && this.isGenericHide();
    }
    isSpecificHide() {
        return (0, utils_1.getBit)(this.mask, 2097152 /* isSpecificHide */);
    }
    isGenericHide() {
        return (0, utils_1.getBit)(this.mask, 524288 /* isGenericHide */);
    }
    isBadFilter() {
        return (0, utils_1.getBit)(this.mask, 131072 /* isBadFilter */);
    }
    isUnicode() {
        return (0, utils_1.getBit)(this.mask, 16777216 /* isUnicode */);
    }
    fromAny() {
        return this.getCptMask() === FROM_ANY;
    }
    thirdParty() {
        return (0, utils_1.getBit)(this.mask, 32768 /* thirdParty */);
    }
    firstParty() {
        return (0, utils_1.getBit)(this.mask, 16384 /* firstParty */);
    }
    fromImage() {
        return (0, utils_1.getBit)(this.mask, 16 /* fromImage */);
    }
    fromMedia() {
        return (0, utils_1.getBit)(this.mask, 32 /* fromMedia */);
    }
    fromObject() {
        return (0, utils_1.getBit)(this.mask, 64 /* fromObject */);
    }
    fromOther() {
        return (0, utils_1.getBit)(this.mask, 128 /* fromOther */);
    }
    fromPing() {
        return (0, utils_1.getBit)(this.mask, 256 /* fromPing */);
    }
    fromScript() {
        return (0, utils_1.getBit)(this.mask, 512 /* fromScript */);
    }
    fromStylesheet() {
        return (0, utils_1.getBit)(this.mask, 1024 /* fromStylesheet */);
    }
    fromDocument() {
        return (0, utils_1.getBit)(this.mask, 1 /* fromDocument */);
    }
    fromSubdocument() {
        return (0, utils_1.getBit)(this.mask, 2048 /* fromSubdocument */);
    }
    fromWebsocket() {
        return (0, utils_1.getBit)(this.mask, 4096 /* fromWebsocket */);
    }
    fromHttp() {
        return (0, utils_1.getBit)(this.mask, 4 /* fromHttp */);
    }
    fromHttps() {
        return (0, utils_1.getBit)(this.mask, 8 /* fromHttps */);
    }
    fromXmlHttpRequest() {
        return (0, utils_1.getBit)(this.mask, 8192 /* fromXmlHttpRequest */);
    }
    fromFont() {
        return (0, utils_1.getBit)(this.mask, 2 /* fromFont */);
    }
}
